...
export async function createNewsAction(formData: FormData) {
  try {
    ...
    const message = error instanceof Error ? error.message : "Помилка при створенні новини";
...
export async function updateNewsAction(id: string, formData: FormData) {
  try {
    ...
    const message = error instanceof Error ? error.message : "Помилка при оновленні новини";
    return { error: message };
  }
}
...
export async function deleteNewsAction(id: string) {
  try {
    ...
    const message = error instanceof Error ? error.message : "Помилка при видаленні новини";
    return { error: message };
  }
}
...
export async function addCommentAction(newsId: string, content: string) {
  try {
    ...
    const message = error instanceof Error ? error.message : "Помилка при додаванні коментаря";
    return { error: message };
  }
}
